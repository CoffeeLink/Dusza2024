...
INSERT INTO `auth_tokens` VALUES ('��|¢�M�ŖH}',4,'2024-11-11 11:17:56','2024-11-09 11:17:56'),('��7�s`����A)',4,'2024-11-11 18:16:19','2024-11-09 18:16:19'),('�E��qбx�\Zױ\Z8',4,'2024-11-11 19:52:54','2024-11-09 19:52:54'),('�d(�zp��n�##',4,'2024-11-11 20:26:14','2024-11-09 20:26:14'),('�pE�p�����ξ',4,'2024-11-11 20:39:28','2024-11-09 20:39:28'),('�6�vQ��6��T)a',4,'2024-11-12 13:21:00','2024-11-10 13:21:00'),('�ڵ�Q�����W',10,'2024-11-12 17:14:12','2024-11-10 17:14:12'),('�ߞ�s��i�G!',10,'2024-11-12 17:19:34','2024-11-10 17:19:34'),('���	rS������;�',4,'2024-11-12 17:39:24','2024-11-10 17:39:24');
...
INSERT INTO `school_data` VALUES (2,'BBB','SULI','Én','nem@mondom.meg');
...
CREATE TABLE `sherpa_teacher` (
  ...
  `group_id` int(10) unsigned NOT NULL COMMENT 'ebben a csoportban adták meg ezt a tanárt',
...
INSERT INTO `sherpa_teacher` VALUES (1,2,'Én'),(2,2,'Ők');
...
CREATE TABLE `team_data` (
  ...
  `replacement_member_class` varchar(5) DEFAULT NULL,
  `category_id` int(10) unsigned NOT NULL,
  `programming_language_id` int(10) unsigned NOT NULL,
  `approval_state` tinyint(3) unsigned NOT NULL DEFAULT 0 COMMENT 'b00: waiting for approval, b01: school_rep, b10: organizer, b11: approved by both',
  `dissapproval_msg` varchar(2048) DEFAULT NULL,
  PRIMARY KEY (`team_id`),
...
INSERT INTO `team_data` VALUES (2,'String2',2,'A2','A1','A5','2b','3b','5b',NULL,NULL,2,2,3,NULL);
...
INSERT INTO `user` VALUES (4,'test','�Yʄ\\�5�t9�Rލ��|��<P�X��z�Q',3,NULL,NULL),(5,'aron','�Yʄ\\�5�t9�Rލ��|��<P�X��z�Q',1,NULL,NULL),(7,'school_acc','�Yʄ\\�5�t9�Rލ��|��<P�X��z�Q',2,NULL,2),(10,'String','�h�^;�\\�A�)924�)Fd\n�Kڏ�R[��\\',1,2,NULL);
...
-- Dump completed on 2024-11-10 17:47:36
