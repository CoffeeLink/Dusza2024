    ...
    <Artboard className="bg-blue-100 flex">
      <Menu className="w-60 flex flex-col justify-between">
        <div>
          ...
          {/*</Menu.Item>*/}
          <Menu.Item>
            <Link to="/host/schools">
              <AcademicCapIcon className="w-5" /> Iskolák
            </Link>
          </Menu.Item>
          <Menu.Item>
            <Link to="/host/teams">
              <UserGroupIcon className="w-5" /> Csapatok
            </Link>
          </Menu.Item>
          <Menu.Item>
            <Link to="/host/categories">
              <Squares2X2Icon className="w-5" /> Kategóriák
            </Link>
          </Menu.Item>
          <Menu.Item>
            <Link to="/host/languages">
              <CodeBracketIcon className="w-5" /> Programozási nyelvek
            </Link>
          </Menu.Item>
          <Menu.Item>
            <Link to="/host/statistics">
              <ChartPieIcon className="w-5" /> Statisztikák
            </Link>
          </Menu.Item>
        </div>
